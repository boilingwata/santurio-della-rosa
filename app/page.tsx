  ...
  return (
    <main className="w-full">
      ...
      >
        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center pt-14">
          <button
            type="button"
          ...
          >
            <Image
              ...
              priority
              sizes="360px"
              className="object-contain drop-shadow-[0_0_18px_rgba(241,229,213,0.35)]"
            />
          </button>
