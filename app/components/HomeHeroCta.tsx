...
import { homeLabels } from "@/lib/locale";
  ...
  return (
    <div className="absolute bottom-8 left-1/2 z-10 flex -translate-x-1/2 flex-col items-center">
      ...
      <div className="relative flex h-[150px] w-[460px] scale-[0.75] items-center justify-center overflow-hidden">
        ...
        <button
          type="button"
          className="absolute z-10 cursor-pointer whitespace-nowrap px-10 py-3 font-isabella text-4xl text-[#272829] transition-all duration-200 ease-out hover:scale-105 hover:drop-shadow-[0_0_15px_rgba(241,229,213,0.55)] active:scale-95"
        >
          {labels.preRegister}
        </button>
      </div>
